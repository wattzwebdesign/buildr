...
class Text extends Element
{
    ...
    {
        return [
            Field::richtext('body')->required()->default('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.'),
        ];
    }
